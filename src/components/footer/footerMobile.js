      ...
      <section className="flex flex-col justify-between pt-[75px] pb-[10px] border-2 border-x-0 border-b-0 border-t-[#EBEBEC] space-y-[70px] my-[50px]">
        ...
        <div className="flex flex-row justify-between items-center font-rubik">
          <div className="flex flex-col space-y-[15px] ">
            ...
            <div className="flex flex-row items-start font-rubik font-normal text-[12px] text-[#878787] space-x-[5px]">
              <Img
          ...
          <div className="text-[14px] text-[#0E467B] flex flex-col justify-end items-end text-right w-[60%]">
            <text className="font-semibold">Medco Building</text>
            <text>Medco Building III 3rd Floor</text>
            <text>Jl. Ampera Raya No. 18-20 12560 Jakarta - Indonesia</text>
          </div>
        </div>

        <div className="flex justify-center items-center">
        <div className="font-normal text-[#0E467B] text-[13px]">
            <text>&copy; 2024 Elga Networks. All Rights Reserved</text>
          </div>
        </div>
      </section>
    </footer>
